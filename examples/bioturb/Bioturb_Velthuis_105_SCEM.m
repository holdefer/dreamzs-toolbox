...
function [Cfract]=Bioturb_Velthuis_105_SCEM(pars);
...
Cinput=pars(1);         % 0.0001-0.0006
CoefCoef1=pars(2);      % 0.8-1.6
CoefCoef2=pars(3);      % 0.4-1.2
width1=pars(4);         % 50-600 
width2=pars(5);         % 25-300            
vertpos2=pars(6);       % 0.4-0.8
DecDec=pars(7);         % 0.00001-0.0001            
extracarbon=pars(8);    % -5-3
